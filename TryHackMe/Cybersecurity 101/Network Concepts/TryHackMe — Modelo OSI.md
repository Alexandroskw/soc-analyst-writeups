...
> [!WARNING]
> Algunos libros de texto describen al Modelo **TCP/IP** con 5 capas en lugar de 4, separando la **Capa Física** de la **Capa de Enlace**.
...
> [!NOTE]
> Las direcciones `0` y `255` están reservadas para la dirección de red y la de broadcast respectivamente.
...
> [!NOTE]
> _Protocolo sin conexión_ hace referencia a que no necesita asegurar una conexión para empezar a transportar los paquetes, ni se asegura que los
> paquetes llegarán al destino. 
